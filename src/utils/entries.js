const entries = [
  [
    ...
    "react.js, node.js, mongoose, git, jquery, group teamwork",
    "Austin, TX"
  ],
  [
    "The Boon Group",
    ...
    "advanced excel formulas, v-lookup, pivot tables, jira, long-term project management",
    "Austin, TX"
  ],
  [
    ...
    "microsoft outlook, microsoft exel, microsoft access, microsoft cdn",
    "Seattle, WA"
  ]
]
