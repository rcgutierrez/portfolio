...
const projects = [
  ...
  [
    ...
    "Kollaboscope aims to facilitate building playlist collaboratively in a public setting; it's the jukebox for the 21st century. Users go to a 'room', designated from the URL path, and add songs from Youtube. These songs are then played back in order added.",
